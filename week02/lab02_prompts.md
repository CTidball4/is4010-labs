...
YOUR RESPONSE: I liked using Copilot CLI a lot. I felt like the responses I got and the interface was very user friendly. I didn’t like Antigravity to much to be honest although that could very well just be user error and experience. I currently prefer Copilot CLI and Github Copilot in VS code. I think in the future I’ll continue using these two more than the others. I can’t really think of a situation that would make me switch but I’m sure there will be one that comes up and makes me want/need to switch. Overall it was good experience to use these applications.
